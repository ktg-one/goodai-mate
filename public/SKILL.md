...
- **Warm cream paper** (`#FFF0D0`) background, never pure white. **Colour the cards, not the page** — navy / gold / red / black blocks carry the content with cream-on-colour text. A white card on cream reads as unfinished. **never have cream on cream**
...
- **Fonts:** Fraunces sodt+WONK (display) + DM Sans (body) + JetBrains Mono (eyebrows/code). Italic + WONK on Fraunces = emphasis lift, one phrase per surface.
