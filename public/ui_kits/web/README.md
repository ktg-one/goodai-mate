...
The marketing site, recreated against the canonical brand book (`../../good-ai-design-final.html`). Mirrors the structure of `ktg-one/goodai-mate` but pivots from the dark "Perth Disruptor" treatment to the three-colour brand system: **ink + orange + cool paper**, with **WA Ocean** as the third brand surface.
...
| `Footer.jsx` | Dark ink footer with hi-yellow sticker accent. |
