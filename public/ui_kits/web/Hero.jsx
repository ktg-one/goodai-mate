  ...
  return (
    <main className="gai-onepage">
      ...
      <div className="gai-onepage-top">
        <img className="gai-logo" src="../../assets/logo-wordmark.svg" alt="Good&rsquo;ai" />
        <span className="gai-perth-chip">PERTH <span>/</span> WA</span>
      </div>

      <div className="gai-onepage-inner">
        <div style={{ width: '100%' }}>
        <Eyebrow>Business automations · Perth · WA</Eyebrow>

        <h1 className="gai-hero-h1">
          Knock off early.<br/>
          <em>We&rsquo;ll sort the <span className="hl">boring stuff</span>.</em>
        </h1>
