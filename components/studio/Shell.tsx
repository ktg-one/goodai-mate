...
export function StudioFooter() {
  return <footer className="site-footer"><div className="shell"><div className="footer-top"><p>Built in Perth.<br />Good wherever you work.<br /><a href={PHONE_HREF} className="footer-phone">{PHONE_DISPLAY}</a><br /><span className="phone-caption">Business line / AI voice agent</span></p><nav aria-label="Footer navigation"><Link href="/#services">Services</Link><Link href="/#approach">Our approach</Link><a href="https://goodai.up.railway.app/">Field notes <ArrowUpRight size={14} /></a><a href={SURVEY_URL}>Get in touch <ArrowUpRight size={14} /></a></nav></div><Link href="/" className="footer-wordmark" aria-label="Good'Ai home"><Brand large /></Link><div className="footer-bottom"><span>© {new Date().getFullYear()} Good’Ai</span><span>Less busywork. More living.</span><div><Link href="/privacy">Privacy</Link><Link href="/terms">Terms</Link></div></div></div></footer>;
}
