...
## 2026-07-18 - Add ARIA live regions to chat interfaces
**Learning:** Chat interfaces (e.g., using Vercel AI SDK) where incoming streaming messages are appended dynamically do not automatically announce these changes to screen readers.
