...
export default function GlobalError({
  ...
  return (
    <html lang="en">
      <body className="bg-[var(--good-cloud)] text-[var(--good-ink)]">
        <div className="flex min-h-screen items-center justify-center p-6">
          <div className="w-full max-w-md border-2 border-[var(--good-ink)] bg-[var(--paper-deep)] p-8 text-center shadow-[4px_4px_0_var(--good-ink)]">
            ...
            <button
              onClick={() => reset()}
              className="mt-6 red-accent stamp-btn stamp-btn-red inline-flex items-center justify-center font-bold text-lg px-9 py-3.5 border-2 border-[var(--good-ink)]"
            >
              Try again
            </button>
          </div>
