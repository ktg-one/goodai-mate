    ...
    <div className="flex min-h-screen flex-col bg-[var(--paper)] p-6 md:p-12 relative font-sans overflow-hidden">
      ...
      <main className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center flex-1 relative z-10 w-full max-w-7xl mx-auto">
        ...
        <div className="relative w-full h-[420px] lg:h-[520px] stamp-box overflow-hidden order-1 lg:order-2">
          ...
          <div role="group" aria-label="Visualizer mode" className="absolute bottom-4 left-4 z-40 flex border-2 border-[var(--ink)] bg-paper-raised text-[10px] font-mono uppercase font-bold overflow-hidden">
            <button
          ...
          <div role="group" aria-label="Visualizer sensitivity" className="absolute bottom-4 right-4 z-40 flex border-2 border-[var(--ink)] bg-paper-raised text-[10px] font-mono uppercase font-bold overflow-hidden">
            <button
