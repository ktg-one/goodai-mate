...
export default function AutomationPlayground() {
  ...
  // ⚡ Bolt Performance Optimization: Memoize log rendering
  // Prevents O(N) array mapping and Virtual DOM recreation on every keystroke in the controlled text inputs
