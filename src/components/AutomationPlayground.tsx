    ...
    <div className="stamp-card stamp-card-gold p-6 md:p-8 w-full">
      ...
      <div className="grid lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-7 flex flex-col gap-3">
          ...
          <div
            className="border-2 border-[var(--ink)] bg-[var(--navy)] text-[var(--paper)] rounded-xs p-4 font-mono text-xs h-[240px] overflow-y-auto shadow-[inset_1px_1px_0_rgba(0,0,0,0.5)]"
            role="log"
            aria-live="polite"
          >
