...
function ChatInputComponent({ isBusy, onSubmit }: ChatInputProps) {
...
// ⚡ Bolt Optimization: Memoize the input component to prevent re-rendering the
// entire chat interface (including the potentially large message list) on every keystroke.
